...
function Navbar() {
  return (
    ...
    <nav class="navbar" style={{backgroundColor: '#000000',
      ...
      <img class="logo" style={{marginTop: '9px', marginLeft: '30px'}} alt="File:Heretics logo.svg" width="50" height="50" src="../../assets/imgs/hereticsLogo.png"/>
      </a>
      <h1 class="main-title">RECOMPENSAS DEL TEAM HERETICS</h1>
    </nav>
    </div>
  );
}
